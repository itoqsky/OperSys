...
{
    // printf("%d\n", primes_count_in_interval(0, 10000000));
  ...
  for (int i = 0; i < n_threads; i++)
  {
    /*
      TODO
      Complete this loop. You shall spawn <n_threads> threads, each of which computes the number of primes in a segment of length <segment_size>.
